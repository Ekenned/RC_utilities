...
for sens = 1:num_sensors
    ...
    feature_struct.feat_VOC =   feat_VOC;
    feature_struct.feat_P =     feat_P;
    feature_struct.feat_T =     feat_T;
    %feature_struct.feat_VOC_d =   feat_VOC_d;
    %feature_struct.feat_P_d =     feat_P_d;
    %feature_struct.feat_T_d =     feat_T_d;
    feature_struct.labels =     labels;

    save feature_struct feature_struct
...
feature_struct.dataset = dataset;
% feature_struct2.name = name;
feature_struct.feat_mat_concat = feat_mat_concat;
feature_struct.lv_norm =    lv_norm;
feature_struct.feat_VOC =   feat_VOC;
feature_struct.feat_P =     feat_P;
feature_struct.feat_T =     feat_T;
feature_struct.feat_VOC_d =   feat_VOC_d;
